...
corr_lbls = {'alpha', 'alpha2', 'beta', 'sigma', 'alpha_sum', 'alpha_difference', 'alpha_difference_over_sigma','alpha_sum_over_sigma', 'RI', ...
    ...
    'matching_measure'};
matrix_labels = {'alpha_{rew}', 'alpha_{unrew}', '1/\sigma', '\sigma', '\alpha_{rew} + \alpha_{unrew}', '\alpha_{rew} - \alpha_{unrew}', '(\alpha_{rew} - \alpha_{unrew})/\sigma', '(\alpha_{rew} + \alpha_{unrew})/\sigma',...
    "RI", "RI(better)",...
