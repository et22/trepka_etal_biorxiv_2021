...
%[a0, ~] = polyfit(output.reward_fraction(output.(subs(1))), output.choice_fraction(output.(subs(1))),1);
%plot([.1 .9], a0(1)*[.1 .9] +a0(2),'color',colors(1),'LineWidth',2.5);
%[a0, ~] = polyfit(output.reward_fraction(output.(subs(2))), output.choice_fraction(output.(subs(2))),1);
%plot([.1 .9], a0(1)*[.1 .9] +a0(2),'color',colors(2),'LineWidth',2.5)
p2.MarkerSize = 5;
p3.MarkerSize = 5;
