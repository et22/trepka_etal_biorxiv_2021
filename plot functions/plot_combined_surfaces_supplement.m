function plot_combined_surfaces_supplement(output1,output2,point_col1,point_col2)
hold off;
 h = heatmap([1,2]);
 map = h.Colormap;
...
%%Surface plots 
    ...
    hold on;    
    g = scatter3(output1.(bd_labels(i,1)),output1.(bd_labels(i,2)),output1.(bd_labels(i,3)),  'filled', 'MarkerFaceColor', point_col1);
    g.SizeData = 20;
    g = scatter3(output2.(bd_labels(i,1)),output2.(bd_labels(i,2)),output2.(bd_labels(i,3)),  'filled', 'MarkerFaceColor', point_col2);
    g.SizeData = 20;    
...
%%Surface plots 
    ...
    hold on;
    g = scatter3(output1.(bd_labels(i,1)),output1.(bd_labels(i,2)),ones(size(output1.(bd_labels(i,2)),1), size(output1.(bd_labels(i,2)),2)),'filled','MarkerFaceColor', point_col1);
    g.SizeData = 20;
    g = scatter3(output2.(bd_labels(i,1)),output2.(bd_labels(i,2)),ones(size(output2.(bd_labels(i,2)),1), size(output2.(bd_labels(i,2)),2)),'filled','MarkerFaceColor', point_col2);
    g.SizeData = 20;    
    set(gca, 'XTick', [0:.5:1], 'YTick', [0:.5:1], 'ZTick', [0:.5:1]);
    set(gca,'FontName','Helvetica','FontSize',16);
