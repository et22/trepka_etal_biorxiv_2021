function analyze_models_complete(only_fit)
close all;
                ...
                for sescnt = 1:numel(models{k}.stats_sim)/num_sim
                    for sim_cnt = 1:num_sim
                        ...
                        for blockcnt = 1:numel(stats.block_indices)
                            ...
                            output.(models{k}.name).(data_subsets{data_idx}(1))(all_blockcnt) = stats.(data_subsets{data_idx}(1))(blockcnt);
                            output.(models{k}.name).(data_subsets{data_idx}(2))(all_blockcnt) = stats.(data_subsets{data_idx}(2))(blockcnt);
